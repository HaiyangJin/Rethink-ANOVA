---
title             : 'Appendices for "Hello again, ANOVA! Rethink ANOVA as a confirmatory data analysis"'
...
authornote        : |
  This is the appendices for "Hello again, ANOVA! Rethink ANOVA as a confirmatory data analysis".
...
For all these effects, the convention alpha level of 5% would be used at the single test level, and, therefore, the Hypothesis-based Type I Error Rate (HER) is not higher than 5% (see Appendix 3).
...
papaja::r_refs(file = "references.bib")
```
