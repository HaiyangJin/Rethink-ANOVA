...
# Simulations for false positive rates in ANOVA conventions

```{r include=FALSE}
# bookdown::preview_chapter("02-anova_simulation.Rmd", "bookdown::html_document2") 
```

This section is the simulations for estimating the false positive rates associates with ANOVA conventions (A, B, and C). 
...
## Simulating false positive rate in ANOVA

We simulate the different false positive rates in 
