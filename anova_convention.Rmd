...
df_TypeI_inter <- sig_inter_simple(p_inter_simple, 0.05) %>% 
  mutate(
    # only any simple effect is significant (regardless of interaction) [4 in total]
    sig_anysimple4 = N_sigsimple4 > 0, 
    # only any simple effect By A is significant (regardless of interaction) [2 in total]
    sig_anysimple2byA = N_sigsimple2byA > 0, 
    # only any simple effect By B is significant (regardless of interaction) [2 in total]
    sig_anysimple2byB = N_sigsimple2byB > 0, 
    # both interaction and (one of) simple effects are significant [4 simple effects]
    sig_both_inter_simple4 = sig_inter * sig_anysimple4, 
    # both interaction and (one of) simple effects By A are significant [2 simple effects]
    sig_both_inter_simple2byA = sig_inter * sig_anysimple2byA,
    # both interaction and (one of) simple effects By B are significant [2 simple effects]
