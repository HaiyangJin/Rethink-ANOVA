...
# ggsave(file.path("images","fig_simu_TypeI_omni.png"), fig_simu_a, width = 4, height = 5.6)
fig_simu_a
```
...
# ggsave(file.path("images","fig_simu_TypeI_omni_supp.png"), fig_simu_a_supp, width = 14, height = 5.6)
fig_simu_a_supp
```
...
# ggsave(file.path("images","fig_simu_single_omni.png"), fig_simu_single_a, width = 4, height = 5.6)
fig_simu_single_a
```
...
# ggsave(file.path("images","fig_simu_single_omni_supp.png"), fig_simu_single_a_supp, width = 10, height = 7)
...
# ggsave(file.path("images","fig_simu_TypeI_mainpost.png"), fig_simu_b, width = 8, height = 5.6)
fig_simu_b
```
...
# ggsave(file.path("images","fig_simu_TypeI_mainpost_supp.png"), fig_simu_b_supp, width = 13, height = 8)
fig_simu_b_supp
```
...
# ggsave(file.path("images","fig_simu_single_mainpost.png"), 
...
# ggsave(file.path("images","fig_simu_single_mainpost_supp.png"), 
...
# ggsave(file.path("images","fig_simu_TypeI_inter.png"), fig_simu_c, width = 10, height = 4)
fig_simu_c
```
...
# ggsave(file.path("images","fig_simu_TypeI_inter_supp.png"), fig_simu_c_supp, width = 10, height = 4)
fig_simu_c_supp
```
...
df_TypeI_inter_single <- sig_inter_simple(p_inter_simple, 0.05) %>% 
  ...
  mutate(contrast = case_when(
    ...
    contrast == "TypeI_cber_inter" ~ "Interation",
    TRUE ~ contrast),
    contrast = as_factor(contrast),
    contrast = fct_relevel(contrast, "CBER", "Interation",
                           "a1_(b1 - b2)", "a2_(b1 - b2)"),
    Method = fct_reorder(Method, TypeI, mean, .desc=TRUE),
...
fig_simu_single_c <- df_TypeI_inter_single %>% 
  ...
  scale_fill_manual(values = c(custom_clr[1], "#000000", custom_clr[2:7])) +
  geom_hline(yintercept = 5, linetype= "dashed", color="gray25") +
  scale_y_continuous(limits = c(0, 7), expand = c(0, 0), breaks = 1:6) +
  labs(y = "Type I Error Rate (%)", fill = "") +
  guides(fill=guide_legend(nrow=2,byrow=TRUE)) +
...
# ggsave(file.path("images","fig_simu_single_inter.png"), fig_simu_single_c, width = 12, height = 5)
fig_simu_single_c
```
...
# ggsave(file.path("images","fig_simu_single.png"), fig_simu_single, width = 12, height = 10)
fig_simu_single
```
